...
CREATE TABLE IF NOT EXISTS borrow (
    ...
    -- Borrow table constraints anfd foreign keys
...
('ALODIA','BALENDEZ','BSIT'),
('ARCHIE','BALENDEZ','BSBA-MM'),
('ATHENA','BALENDEZ','BSBA-OM'),
('AMIEL','ARANAS','BSFT');
...
('DOSAGE OF SEROTONIN','INKSTEADY','ROMANCE'),
('HIS INTO HER','MAXINEJIJI','ROMANCE'),
('PROJECT LOKI','AKOSIIBARRA','MYSTERY'),
('WHIPPED','JONAXX','ROMANCE');
